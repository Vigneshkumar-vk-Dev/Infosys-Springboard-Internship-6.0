...
const Dashboard = () => {
    const revenueData = [
      { month: 'Apr', revenue: 80 }, { month: 'May', revenue: 82 }, { month: 'Jun', revenue: 95 },
      { month: 'Jul', revenue: 90 }, { month: 'Aug', revenue: 105 }, { month: 'Sep', revenue: 115 },
    ];
            ...
            <div className="main-grid">
                ...
                <aside className="right-sidebar">
                    <div className="widget-card fleet-utilization">
                        ...
                        <div className="chart-legend"><span>Active Trips</span><span>Idle</span><span>Maintenance</span></div>
                    </div>
                    <div className="widget-card">
                        <h4>Recent trip</h4>
                        <ul className="info-list"><li><div className="item-icon">🚐</div><div className="item-details"><strong>David's vans</strong><span>123 Green st to 125 Kings Rd</span></div><span className="item-status">Done</span></li></ul>
                    </div>
                    <div className="widget-card">
                        <h4>Live Tracking</h4>
